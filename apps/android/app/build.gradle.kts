...
android {
    ...
    buildTypes {
        getByName("debug") {
            ...
            // exercised on supported test devices without shipping translations.
...
// product behavior. Production signing, complete GLAZE UI V1.2 native-device
