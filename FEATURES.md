...
- Current stacked Development candidate identity `0.1.0-beta.1+android.17` / versionCode `10017`.
...
- External Android handoff is eligible only for a user-gestured non-web scheme.
