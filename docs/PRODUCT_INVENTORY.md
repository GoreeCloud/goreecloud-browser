...
It replaces inherited third-party synchronization and account product experiences.
...
GoreeCloud Browser replaces inherited user-facing bookmark-root fragmentation with a unified GoreeCloud model.
...
Inherited password-management product surfaces are being removed as GoreeCloud Vault reaches validated operational readiness.
...
This section is intentionally incomplete pending the next supplied portion of the product inventory.