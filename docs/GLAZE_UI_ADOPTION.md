...
- Browser beta identity for this mapping/hardening stack: `0.1.0-beta.1+android.14` / versionCode `10014`
...
- The localization-resource, pseudolocale, bidi-presentation, and explicit-port hardening create testing/source boundaries only. They do not establish actual translations, translation completeness/quality, locale fallback/plural/grammar behavior, complete origin/Unicode/IDN/confusable handling, bidirectional URL/address editing, rendered pseudolocale behavior, rendered RTL layout, or representative locale/device acceptance.
