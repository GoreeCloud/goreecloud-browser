...
- Debug-beta version on this stacked Development branch: `0.1.0-beta.1+android.18`
...
- Browser-owned navigation resolution, bare-host inference, and external-handoff routing apply their independent fail-closed contracts without turning Glaze presentation into security, origin, complete scheme/intent/deep-link, userinfo, email, or external-application authority;
