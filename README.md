...
Private Browsing, full tab-management UI, accepted permission surfaces, production Wardveil downloads, full first-party runtime integrations, actual locale translations, representative pseudolocale/large-text/assistive-technology/localization/RTL acceptance, complete DNS/origin/Unicode/IDN/confusable and bidirectional editing acceptance, complete URL/userinfo/email-classification/phishing acceptance, complete scheme/intent/deep-link and external-application trust acceptance, managed updates/rollback, production signing, store distribution, and Stable qualification remain incomplete.
